...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Challenge.alt_time'
        db.delete_column('challenge_challenge', 'alt_time')

        # Deleting field 'Challenge.min_participants'
        db.delete_column('challenge_challenge', 'min_participants')

        # Deleting field 'Challenge.latest_signup'
        db.delete_column('challenge_challenge', 'latest_signup')

        # Deleting field 'Challenge.alt_date'
        db.delete_column('challenge_challenge', 'alt_date')

        # Deleting field 'Challenge.max_participants'
        db.delete_column('challenge_challenge', 'max_participants')

        # Adding field 'Challenge.is_deleted'
        db.add_column('challenge_challenge', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Challenge.deleted_reason'
        db.add_column('challenge_challenge', 'deleted_reason',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Challenge.alt_time'
        db.add_column('challenge_challenge', 'alt_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Challenge.min_participants'
        db.add_column('challenge_challenge', 'min_participants',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Challenge.latest_signup'
        db.add_column('challenge_challenge', 'latest_signup',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=2),
                      keep_default=False)

        # Adding field 'Challenge.alt_date'
        db.add_column('challenge_challenge', 'alt_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Challenge.max_participants'
        db.add_column('challenge_challenge', 'max_participants',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Challenge.is_deleted'
        db.delete_column('challenge_challenge', 'is_deleted')

        # Deleting field 'Challenge.deleted_reason'
        db.delete_column('challenge_challenge', 'deleted_reason')
