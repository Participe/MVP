...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('organization_organization', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 12, 2, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'Organization.postal_code'
        db.alter_column('organization_organization', 'postal_code', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Organization.created_at'
        db.delete_column('organization_organization', 'created_at')


        # Changing field 'Organization.postal_code'
        db.alter_column('organization_organization', 'postal_code', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
