...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.location'
        db.add_column('challenge_challenge', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Challenge.duration'
        db.add_column('challenge_challenge', 'duration',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.location'
        db.delete_column('challenge_challenge', 'location')

        # Deleting field 'Challenge.duration'
        db.delete_column('challenge_challenge', 'duration')
    ...
    models = {
        ...
        'challenge.challenge': {
            ...
            'alt_date': ('django.db.models.fields.DateField', [], {}),
            ...
            'alt_time': ('django.db.models.fields.TimeField', [], {}),
            ...
            'max_participants': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'min_participants': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
