...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participation.selfreflection_activity_text'
        db.add_column('challenge_participation', 'selfreflection_activity_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Participation.selfreflection_learning_text'
        db.add_column('challenge_participation', 'selfreflection_learning_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Participation.selfreflection_rejection_text'
        db.add_column('challenge_participation', 'selfreflection_rejection_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Participation.acknowledgement_text'
        db.add_column('challenge_participation', 'acknowledgement_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Participation.date_selfreflection'
        db.add_column('challenge_participation', 'date_selfreflection',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Participation.date_selfreflection_rejection'
        db.add_column('challenge_participation', 'date_selfreflection_rejection',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Participation.date_acknowledged'
        db.add_column('challenge_participation', 'date_acknowledged',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Participation.selfreflection_activity_text'
        db.delete_column('challenge_participation', 'selfreflection_activity_text')

        # Deleting field 'Participation.selfreflection_learning_text'
        db.delete_column('challenge_participation', 'selfreflection_learning_text')

        # Deleting field 'Participation.selfreflection_rejection_text'
        db.delete_column('challenge_participation', 'selfreflection_rejection_text')

        # Deleting field 'Participation.acknowledgement_text'
        db.delete_column('challenge_participation', 'acknowledgement_text')

        # Deleting field 'Participation.date_selfreflection'
        db.delete_column('challenge_participation', 'date_selfreflection')

        # Deleting field 'Participation.date_selfreflection_rejection'
        db.delete_column('challenge_participation', 'date_selfreflection_rejection')

        # Deleting field 'Participation.date_acknowledged'
        db.delete_column('challenge_participation', 'date_acknowledged')
