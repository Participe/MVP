...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('challenge_challenge', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organization.Organization'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.organization'
        db.delete_column('challenge_challenge', 'organization_id')
    ...
    models = {
        ...
        'challenge.challenge': {
            ...
            'alt_date': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
            ...
            'alt_time': ('django.db.models.fields.TimeField', [], {'blank': 'True'}),
            'application': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '2'}),
            'contact_person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'blank': 'True'}),
