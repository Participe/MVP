...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('account_userprofile', 'confirmation_code',
                      self.gf('django.db.models.fields.CharField')(max_length=33, null=True, blank=True),
                      keep_default=False)


        # Changing field 'UserProfile.address_1'
        db.alter_column('account_userprofile', 'address_1', self.gf('django.db.models.fields.CharField')(default='', max_length=80))

    def backwards(self, orm):
        # Deleting field 'UserProfile.confirmation_code'
        db.delete_column('account_userprofile', 'confirmation_code')
    ...
    models = {
        'account.userprofile': {
            ...
            'address_1': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
