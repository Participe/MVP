...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.avatar'
        db.add_column('organization_organization', 'avatar',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.avatar'
        db.delete_column('organization_organization', 'avatar')
