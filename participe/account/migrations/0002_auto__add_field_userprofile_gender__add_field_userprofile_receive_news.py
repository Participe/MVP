...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.receive_newsletter'
        db.add_column('account_userprofile', 'receive_newsletter',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.receive_newsletter'
        db.delete_column('account_userprofile', 'receive_newsletter')
