...
urlpatterns += patterns('participe.account.views',
    ...
    url(r'^accounts/profile/$', 'view_myprofile', name='view_myprofile'),
    url(r'^accounts/profile/(?P<user_id>[\w_-]+)/$', 'view_profile',
            name='view_profile'),
    url(r'^accounts/edit/$', 'edit_profile', name='edit_profile'),
    url(r'^accounts/delete/$', 'delete_profile', name='delete_profile'),
