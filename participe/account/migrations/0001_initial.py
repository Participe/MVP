...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('account_userprofile', (
            ...
            ('postal_code', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=10, null=True, blank=True)),
            ...
            ('birth_day', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ...
            ('privacy_mode', self.gf('django.db.models.fields.CharField')(default='1', max_length=2)),
            ('fb_profile_link', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('confirmation_code', self.gf('django.db.models.fields.CharField')(max_length=33, null=True, blank=True)),
        ))
