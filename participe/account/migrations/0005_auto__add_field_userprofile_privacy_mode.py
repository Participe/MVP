...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.privacy_mode'
        db.add_column('account_userprofile', 'privacy_mode',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.privacy_mode'
        db.delete_column('account_userprofile', 'privacy_mode')
