...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('challenge_challenge', (
            ...
            ('alt_date', self.gf('django.db.models.fields.DateField')()),
            ('alt_time', self.gf('django.db.models.fields.TimeField')()),
            ('min_participants', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True)),
            ('max_participants', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True)),
        ))
