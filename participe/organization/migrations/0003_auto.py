...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field affiliated_user on 'Organization'
        db.create_table('organization_organization_affiliated_user', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('organization', models.ForeignKey(orm['organization.organization'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('organization_organization_affiliated_user', ['organization_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field affiliated_user on 'Organization'
        db.delete_table('organization_organization_affiliated_user')
    ...
    models = {
        ...
        'organization.organization': {
            ...
            'affiliated_user': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
