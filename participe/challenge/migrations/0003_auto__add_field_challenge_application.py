...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.application'
        db.add_column('challenge_challenge', 'application',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.application'
        db.delete_column('challenge_challenge', 'application')
